...
| Large-repository index | Historical: the CBM full index failed the retained memory policy and the later CodeGraph comparison passed it before both tools were retired in 2026-09. No current capability indexes repositories; see the replacement design and retirement record |
...
The helper does not take shared-service admission. Do not replace the live Python
...
The [graph-provider ownership/order map](../../openspec/changes/archive/2026-09-17-migrate-harness-to-rust/design.md#graph-provider-ownership-and-order)
...
> Superseded 2026-09-23: CodeGraph and the CBM rollback route were removed
> entirely; see [legacy-mcp-retirement](legacy-mcp-retirement.json). The
> remainder of this section is historical evidence for that replacement.
