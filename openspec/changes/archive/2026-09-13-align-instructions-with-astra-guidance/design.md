...
| [improve-installed-tool-workflows](../../improve-installed-tool-workflows/proposal.md) | The shared skills keep current MCP/root/coverage and memory-tool constraints. Global real-consumer and benefit acceptance stays with that change. Description/refactoring work here does not close its tasks. |
