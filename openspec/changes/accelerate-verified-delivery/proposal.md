...
This reconciliation does not resume the original source-kit consumer work, restore ordinary hooks, or close tasks 5.4 or 6.4. Task 5.3 later completed the five local controlled native pairs on hooks-off Astra; benefit remains unproven. Fast remains excluded; OpenAI assignments remain Astra-only.
