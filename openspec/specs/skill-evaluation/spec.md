...
This contract evaluates library mutations. Orchestration-default gates in `orchestrate-feedback-and-pacing` SHALL NOT substitute for it, and this contract SHALL NOT be required of non-library orchestration defaults.
