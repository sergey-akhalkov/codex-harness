# Automatic LSP Diagnostics Specification

## Purpose

Define strict mutation, freshness and delivery contracts for automatic diagnostics only when their scope passes the benefit gate; ordinary development keeps hooks and automatic diagnostics disabled.
