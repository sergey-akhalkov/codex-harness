...
$dispatchCases = @(
    ...
    @{ Name = 'explicit zai profile'; Arguments = @('--profile', 'zai', 'exec'); Select = $false },
    @{ Name = 'short zai profile'; Arguments = @('-p', 'zai'); Select = $false },
    @{ Name = 'attached zai profile'; Arguments = @('-pzai'); Select = $false },
