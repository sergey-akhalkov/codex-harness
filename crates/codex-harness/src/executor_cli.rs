...
mod tests {
    ...
    fn exec_dispatch_records_the_control_route_with_the_resolved_binding() {
        ...
        save_receipt(
            ...
            &shell,
            &observed,
            &control::OriginatingLead {
                schema: 1,
                thread_id: "lead-thread".into(),
                run_generation: "lead-generation".into(),
                dispatcher: control::DispatcherIdentity {
                    pid: 4242,
                    creation_time: 1,
                    program: PathBuf::from(r"C:\lead\codex.exe"),
                },
            },
        )
        .unwrap();
